...
*  any later version.
*
*  This Program is distributed inq the hope that it will be useful,
...
public:
	...
	*/
	...
	static void JoinString(const StringArray &strings, const std::string& delimiter, std::string& result);
	static std::string JoinString(const StringArray &strings, const std::string& delimiter);
	static std::string Join(const std::vector<std::string> &strings, const std::string& delimiter);
	static int SplitString(const std::string& input, const std::string& delimiter, StringArray &results, unsigned int iMaxStrings = 0);
	static StringArray SplitString(const std::string& input, const std::string& delimiter, unsigned int iMaxStrings = 0);
	...
	* Next functions get parameter as char and don't need double cast ((int)(unsigned char) is required for standard functions). */
	...
	static int FindBestMatch(const std::string &str, const StringArray &strings, double &matchscore);
	static bool ContainsKeyword(const std::string &str, const StringArray &keywords);
	...
	*/
	...
	static std::string  wchar_to_char_string(const wchar_t* theWString, const char substituteCharacter = (char)0xfe);
	static std::wstring char_to_wchar_string(const char* theString);
