...
public:
	...
	bool Post(const CStdString& strURL, const CStdString& strPostData, std::string& strHTML);
	...
	void SetMimeType(CStdString mimetype)                      { SetRequestHeader("ContentType", mimetype); }
...
protected:
	...
	bool Service(const CStdString& strURL, std::string& strHTML);
