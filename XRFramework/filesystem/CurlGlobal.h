...
public: 
	...
	static void easy_aquire(const char *protocol, const char *hostname, CURL_HANDLE** easy_handle, CURLM** multi_handle);
	static void easy_release(CURL_HANDLE** easy_handle, CURLM** multi_handle);
	static void easy_duplicate(CURL_HANDLE* easy, CURLM* multi, CURL_HANDLE** easy_out, CURLM** multi_out);
	static CURL_HANDLE* easy_duphandle(CURL_HANDLE* easy_handle);
