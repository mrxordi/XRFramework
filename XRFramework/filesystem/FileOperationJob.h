...
public:	
	...
	const FileItemList &GetItems()         const { return m_items; }
...
private:
	...
	bool DoProcess(FileAction action, FileItemList& items, const std::string& strDestFile, FileOperationList &fileOperations, double &totalTime);
